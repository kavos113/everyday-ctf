...
0000000000400510 <print_file@plt>:
  400510:	ff 25 0a 0b 20 00    	jmp    QWORD PTR [rip+0x200b0a]        # 601020 <print_file>
...
0000000000400520 <_start>:
  ...
  40052d:	50                   	push   rax
  40052e:	54                   	push   rsp
  40052f:	49 c7 c0 a0 06 40 00 	mov    r8,0x4006a0
  400536:	48 c7 c1 30 06 40 00 	mov    rcx,0x400630
...
0000000000400630 <__libc_csu_init>:
  ...
  40063b:	4c 8d 25 ae 07 20 00 	lea    r12,[rip+0x2007ae]        # 600df0 <__frame_dummy_init_array_entry>
  400642:	55                   	push   rbp
  400643:	48 8d 2d ae 07 20 00 	lea    rbp,[rip+0x2007ae]        # 600df8 <__do_global_dtors_aux_fini_array_entry>
  40064a:	53                   	push   rbx
  ...
  40065c:	e8 6f fe ff ff       	call   4004d0 <_init>
  ...
  400694:	c3                   	ret
  400695:	90                   	nop
  400696:	66 2e 0f 1f 84 00 00 	cs nop WORD PTR [rax+rax*1+0x0]
  40069d:	00 00 00 
